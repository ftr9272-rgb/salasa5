...
// Module-level mock quotations so hooks can reference stable data
const MOCK_QUOTATIONS_PAYMENTS = [
  { id: 1, title: 'عرض سعر: أثاث مكتبي', description: 'عرض سعر لتوريد أثاث مكتبي متكامل', supplier: { id: 1, company_name: 'شركة النور للإلكترونيات' }, total_amount: 18500, status: 'sent', items: [{ name: 'مكاتب إدارية', quantity: 8, price: 3000, unit: 'قطعة' }], created_at: '2024-01-12', valid_until: '2024-02-12' },
  { id: 2, title: 'عرض سعر: إلكترونيات مكتبية', description: 'عرض سعر لتوريد أجهزة كمبيوتر ومعدات إلكترونية', supplier: { id: 3, company_name: 'شركة التقنية الآمنة' }, total_amount: 22000, status: 'accepted', items: [{ name: 'حواسيب محمولة', quantity: 6, price: 4000, unit: 'قطعة' }], created_at: '2024-01-10', accepted_at: '2024-01-15' }
];
...
const MerchantPayments = () => {
  ...
  const fetchQuotations = useCallback(async () => {
    ...
    try {
      ...
      setQuotations(MOCK_QUOTATIONS_PAYMENTS);
    } catch (error) {
  ...
  <h1 className="text-3xl font-bold text-gray-800 dark:text-white">المدفوعات</h1>
