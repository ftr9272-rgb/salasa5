...
const MerchantReceivedQuotations = () => {
...
// mock data now created inside loader to avoid hook dependency issues
  ...
  return (
    <ErrorBoundary>
      <div className="p-6 space-y-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">عروض الأسعار المستلمة</h1>
...
export default MerchantReceivedQuotations;
