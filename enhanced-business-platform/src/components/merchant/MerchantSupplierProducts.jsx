...
const MerchantSupplierProducts = () => {
  ...
  useEffect(() => {
    const fetchQuotations = async () => {
      ...
      try {
        ...
        // mock placed inside effect so it doesn't appear in deps
        const MOCK_SUPPLIER_QUOTATIONS = [
          { id: 1, title: 'عرض سعر: أثاث مكتبي', description: 'عرض سعر لتوريد أثاث مكتبي متكامل', supplier: { id: 1, company_name: 'شركة النور للإلكترونيات' }, total_amount: 18500, status: 'sent', items: [{ name: 'مكاتب إدارية', quantity: 8 }], created_at: '2024-01-12', valid_until: '2024-02-12' },
          { id: 2, title: 'عرض سعر: إلكترونيات مكتبية', description: 'عرض سعر لتوريد أجهزة كمبيوتر', supplier: { id: 3, company_name: 'شركة التقنية الآمنة' }, total_amount: 22000, status: 'accepted', items: [{ name: 'حواسيب محمولة', quantity: 6 }], created_at: '2024-01-10', accepted_at: '2024-01-15' }
        ];

        setQuotations(MOCK_SUPPLIER_QUOTATIONS);
      } catch (error) {
  ...
  <h1 className="text-3xl font-bold text-gray-800 dark:text-white">منتجات المورد</h1>
...
export default MerchantSupplierProducts;
