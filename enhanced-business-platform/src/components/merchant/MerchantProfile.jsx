...
// module-level mock data so hooks don't require it as a dependency
const MOCK_QUOTATIONS = [
    {
      id: 1,
      title: 'عرض أسعار لطلب معدات مكتبية',
      description: 'قائمة بمستلزمات مكتبية مطلوبة من التاجر',
      supplier: { company_name: 'مورد الأنظمة الحديثة' },
      total_amount: 12500,
      items: [{ name: 'طاولة مكتب', qty: 10 }, { name: 'كرسي', qty: 10 }],
      valid_until: '2025-09-12',
      status: 'sent'
    },
    {
      id: 2,
      title: 'عرض أسعار شاشات عرض',
      description: 'شاشات بقياس 24 و 27 بوصة',
      supplier: { company_name: 'الشاشات المتحدة' },
      total_amount: 9500,
      items: [{ name: 'شاشة 24"', qty: 5 }],
