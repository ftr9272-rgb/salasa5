...
const SupplierOrders = () => {
  ...
  const [_showOrderDetails, _setShowOrderDetails] = useState(false);
  ...
  const handleStatusUpdate = (orderId, newStatus) => {
    ...
    // في التطبيق الحقيقي، سيتم إرسال طلب API لتحديث حالة الطلب
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        _setShowOrderDetails(true);
                        // في التطبيق الحقيقي، يمكن فتح نافذة منبثقة أو الانتقال لصفحة التفاصيل
                        console.log('عرض تفاصيل الطلب:', order.orderNumber);
                      }}
                    >
